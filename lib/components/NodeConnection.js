...
var NodeConnectionMenu_1 = require("./NodeConnectionMenu");
    ...
    function NodeConnection(props) {
        ...
        _this.buildCustomMenuOverlay = function (menu) {
            ...
            for (var _i = 0, menu_1 = menu; _i < menu_1.length; _i++) {
                ...
                menuItems.push(React.createElement(NodeConnectionMenu_1["default"], { name: menuEntry[0], key: menuEntry[0], action: menuEntry[2], icon: menuEntry[1], connection: _this.props }));
            }
