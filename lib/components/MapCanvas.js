...
var MapCanvas = /** @class */ (function (_super) {
    ...
    function MapCanvas(props) {
        ...
        _this.componentWillMount = function () {
            MapEditorStore.addChangeListener(_this.onChange);
            MapStore.addChangeListener(_this.onChange);
        };
        _this.componentWillUnmount = function () {
            MapEditorStore.removeChangeListener(_this.onChange);
            MapStore.addChangeListener(_this.onChange);
        };
        ...
        _this.constructRubberBand = function () {
            if (!_this.state.mouseDrag) {
                ...
                return React.createElement(RubberBand, { startPos: _this.state.mouseDragStart, endPos: _this.state.mouseDragStop, parentHeight: _this.state.height, parentWidth: _this.state.width });
            }
        };
        ...
        _this.onChange = function () {
            _this.setState(MapEditorStore.getState());
        };
        _this.jsPlumbInstance = props.jsPlumbInstance;
        _this.input = null;
        _this.state = MapEditorStore.getState();
        return _this;
    }
    ...
    MapCanvas.prototype.selectSelectedNodes = function () {
        ...
        if (this.state.mouseDrag) {
            for (var _i = 0, _a = MapStore.getState().nodes; _i < _a.length; _i++) {
                var node = _a[_i];
    ...
    MapCanvas.prototype.renderConnections = function (connections) {
        ...
        var _loop_1 = function (connectionDescription) {
            ...
            result.push(React.createElement(NodeConnection, { jsPlumbInstance: this_1.jsPlumbInstance, key: key, label: connectionDescription.label, scope: connectionDescription.scope, sourceId: connectionDescription.sourceId, styler: this_1.props.connectionStyler, targetId: connectionDescription.targetId, focused: focused }));
        };
        var this_1 = this;
