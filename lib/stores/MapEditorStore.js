...
import { BlurAllEvent, BlurConnectionEvent, BlurNodeEvent, ConnectionSendForProcessing, DragStartedEvent, DragStoppedEvent, FocusAddNodeEvent, FocusConnectionEvent, FocusNodeEvent, MapResizeEvent, ScopeActivatedEvent, ScopeDectivatedEvent } from "../actions/MapEditorActions";
...
var mapEditorStoreInstance = new MapEditorStore(MapEditorDispatcher);
